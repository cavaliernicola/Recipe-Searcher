...
*Make sure to run production build and not development, otherwise you might experience [unwanted](https://stackoverflow.com/a/61897567) re-render, unless you change `<React.StrictMode>` to `<>` in [main.jsx](https://github.com/cavaliernicola/Recipe-Searcher/blob/f8ddfbaaca6734eb6cf1d8eef2d9aca6cf764079/src/main.jsx#L8)*
